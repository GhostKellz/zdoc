...
pub fn build(b: *std.Build) void {
    ...
    const exe = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            ...
            // root module.
            .imports = &.{
                // Here "zdoc" is the name you will use in your source code to
                // import this module (e.g. `@import("zdoc")`). The name is
    ...
    // Create comprehensive zdoc tests
    const zdoc_tests = b.addTest(.{
        .root_module = b.createModule(.{
            .root_source_file = b.path("tests/zdoc_tests.zig"),
            .target = target,
            .optimize = optimize,
            .imports = &.{
                .{ .name = "zdoc", .module = mod },
